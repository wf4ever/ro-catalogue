...
#
# make.sh - uses ro-manager to create RO structure for the Wings provenance example data, 
# using data and RDF files generated by the preceding scriots.  
# (Within the ro-catalogue project, I am using the file make.sh as a convention for the 
# file that actually builds the RO structures.)
#ß
